	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -3.0F, -1.0F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 6)
		...
		PartDefinition leg8_r1 = legs.addOrReplaceChild("leg8_r1",
				CubeListBuilder.create().texOffs(12, 8).addBox(-0.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
		...
		PartDefinition leg7_r1 = legs.addOrReplaceChild("leg7_r1",
				CubeListBuilder.create().texOffs(12, 10).addBox(-2.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, -0.5F, 4.5F, -0.3491F, -0.6545F, 0.5236F));

		PartDefinition leg6_r1 = legs.addOrReplaceChild("leg6_r1",
				CubeListBuilder.create().texOffs(0, 14).addBox(-1.5F, -0.9F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.5F, -0.5F, 2.5F, -0.1309F, 0.2618F, -0.3927F));

		PartDefinition leg5_r1 = legs.addOrReplaceChild("leg5_r1",
				CubeListBuilder.create().texOffs(14, 6).addBox(-1.5F, -0.9F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, -0.5F, 2.5F, -0.1309F, -0.2618F, 0.3927F));

		PartDefinition leg4_r1 = legs.addOrReplaceChild("leg4_r1",
				CubeListBuilder.create().texOffs(15, 13).addBox(-1.5F, -0.9F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.5F, -0.5F, 0.5F, 0.0F, 0.0F, -0.3927F));

		PartDefinition leg3_r1 = legs
				.addOrReplaceChild("leg3_r1",
						CubeListBuilder.create().texOffs(8, 14).addBox(-1.5F, -0.9F, -0.5F, 3.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(4.5F, -0.5F, 0.5F, 0.0F, 0.0F, 0.3927F));

		PartDefinition leg2_r1 = legs.addOrReplaceChild("leg2_r1",
				CubeListBuilder.create().texOffs(15, 15).addBox(-0.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.5F, -0.5F, -1.5F, 0.2182F, -0.5672F, -0.4363F));

		PartDefinition leg1_r1 = legs.addOrReplaceChild("leg1_r1",
				CubeListBuilder.create().texOffs(0, 16).addBox(-2.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, -0.5F, -1.5F, 0.2182F, 0.5672F, 0.4363F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 8)
						.addBox(-2.0F, -6.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(1.0F, -6.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
