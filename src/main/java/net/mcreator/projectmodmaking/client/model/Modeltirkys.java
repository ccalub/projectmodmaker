...
public class Modeltirkys<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("projectmodmaking", "modeltirkys"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition shell = partdefinition.addOrReplaceChild("shell",
				CubeListBuilder.create().texOffs(0, 9).addBox(2.0F, -5.1584F, 0.9336F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(16, 9)
						.addBox(6.0F, -3.1584F, 1.9336F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)).texOffs(15, 0).addBox(1.0F, -3.1584F, 1.9336F,
								1.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)),
				PartPose.offsetAndRotation(-4.0F, 22.0F, -2.0F, -0.3665F, 0.0F, 0.0F));
		PartDefinition cube_r1 = shell.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.0664F, -3.1584F, -5.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.0F, -3.0F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(12, 9)
						...
						.addBox(1.0F, -1.0F, 4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(15, 5).addBox(-2.0F, -1.0F, 4.0F, 1.0F, 1.0F,
