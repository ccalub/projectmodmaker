...
import net.mcreator.projectmodmaking.client.renderer.LightOwlRenderer;
...
public class ProjectmodmakingModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(ProjectmodmakingModEntities.LIGHT_OWL, LightOwlRenderer::new);
	}
}
